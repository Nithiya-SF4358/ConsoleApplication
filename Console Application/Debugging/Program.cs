...
namespace Debugging
{
    class Program
    {
                        ...
                        if(eligibilty) //If Eligible
                        {
                            if(department.NumberOfSeats > 0) //Checking seat availabilty
                            {
                                ...
                                if(count == 0) //If no admission is taken previously
                                {
                                    ...
                                    AdmissionDetails newAdmission = new AdmissionDetails(currentLoggedInStudent.StudentID,department.DepartmentID,department.DepartmentName,DateTime.Now,AdmissionStatusEnum.Admitted,department.NumberOfSeats);
                                    //Adding the object to the global admission list.
                                    departmentList.Add(newAdmission);
        ...
        static void AddDefaultData()
        {
            ...
            AdmissionDetails admission1 = new AdmissionDetails(studentList[0].StudentID,departmentList[0].DepartmentID,departmentList[0].DepartmentName,DateTime.ParseExact("2023/05/11","yyyy/MM/dd",null),AdmissionStatusEnum.Admitted,departmentList[0].NumberOfSeats);
            admissionList.Add(admission1);
            AdmissionDetails admission2 = new AdmissionDetails(studentList[1].StudentID,departmentList[1].DepartmentID,departmentList[1].DepartmentName,new DateTime(2023,05,12),AdmissionStatusEnum.Admitted,departmentList[1].NumberOfSeats);
